...
1. **全局逃逸（GlobalEscape）**：由于对象可能被多个线程访问，全局逃逸的对象一般不适合进行栈上分配或其他内存优化。但JIT可能会进行其他类型的优化，如方法内联或循环优化。（方法内联参考：[https://www.yuque.com/hollis666/qyhor6/nkr4ge#ovn99](https://www.yuque.com/hollis666/qyhor6/nkr4ge#ovn99) ）
